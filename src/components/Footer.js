...
export default function Footer(props) {
    ...
    return (
        ...
        <div>
            <div className="py-4 px-8 z-10 relative" style={{ backgroundColor: "#2C2A2B" }} >
                <PageButtonLayout />
