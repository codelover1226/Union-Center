          ...
          <div className="flex items-center mb-20">
            <div className="w-auto mx-auto xl:w-1/3">
              ...
              <div className="w-full flex mt-5">
                <select className="m-auto w-full sm:w-1/2 bg-[#153644] border-[1px] text-main-bg rounded-none outline-none p-1" onChange={onchange}>
                  <option value="all" className="m-auto w-1/3 bg-[#153644] border-[1px] outline-main-bg text-main-bg">All</option>
                  <option value="exterior" className="m-auto w-1/3 bg-[#153644] border-[1px] outline-main-bg text-main-bg">Exterior</option>
                  <option value="residences" className="m-auto w-1/3 bg-[#153644] border-[1px] outline-main-bg text-main-bg">Residences</option>
                  <option value="amenities" className="m-auto w-1/3 bg-[#153644] border-[1px] outline-main-bg text-main-bg">Amenities</option>
                  <option value="greenpoint" className="m-auto w-1/3 bg-[#153644] border-[1px] outline-main-bg text-main-bg">Greenpoint</option>
                </select>
              </div>
            </div>
          </div>
