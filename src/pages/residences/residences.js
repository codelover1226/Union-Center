    ...
    return (
        <div>
            ...
            <div className="px-4 content-center z-10 relative" style={{ backgroundColor: "#153644" }} >
                <div className="content-center p-10 py-10">
            ...
            <div className="px-8 content-center py-10 z-10 relative" style={{ backgroundColor: "#153644" }} >
                ...
                <div className="content-center p-12 xl:w-[1280px] m-auto">
                    ...
                    <div className="max-w-[1280px] w-full m-auto mt-[90px] sm:flex">
                        ...
                        <div className="w-full sm:w-1/5 left-0 bottom-0">
