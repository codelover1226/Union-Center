...
export default function Residences() {
    return (
        <div>
            <img src={ BackgroundIamge1} className="inset-0 bg-black opacity-50"/>
                ...
                <div className="content-center xl:w-[900px] m-auto ">
                    <div className="max-w-[1280px] w-full m-auto mt-[10px]">
                        <div className="w-full md:w-1/3 left-0 sm:bottom-0">
                            ...
                            <p className="text-base font-GTPressura-Light text-left text-sm text-white py-3 ">Rooted in Greenpoint’s industrial heritage, The Huron is uniquely contemporary, functional, and inspirational. The H shaped two-tower configuration, with its long, linear connected lobby, is reminiscent of a ship with two smoke stacks.</p>
                        </div>
