      ...
      <div className="px-4 content-center z-10 relative bg-main-bg" >
        <div className="content-center py-20" >
          <div className="m-auto">
            <p className={`text-sm font-GTPressura-Bold text-center ${isScrolledToSection.section1? 'text-dark-bg' : 'text-main-bg'} animate-font-duration pb-5`}>GREENPOINT</p>
          </div>
          <div className="xl:w-[600px] m-auto mb-4">
            <p className={`text-center font-GTPressura-Light text-5xl ${isScrolledToSection.section1? 'text-dark-bg' : 'text-main-bg'} animate-font-duration px-4`}>TAn Authenically 
            Brooklyn Condo</p>
          </div>
        ...
        <div className="w-full flex">
          <div className="w-full md:mx-32 lg:flex mb-6">
            <div className="w-full lg:px-6">
              <p className={`${isScrolledToSection.section0?'text-dark-bg' : 'text-main-bg'} animate-font-duration text-[34px] uppercase`}>
                union center flushing
              </p>
            </div>
            <div className="w-full lg:px-6 mb-6">
              <p className={`${isScrolledToSection.section0?'text-dark-bg' : 'text-main-bg'} animate-font-duration text-base text-justify`}>
