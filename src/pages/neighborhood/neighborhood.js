...
export default function Neighborhood() {
  ...
  useEffect(() => {
    ...
    const sections = [section0Ref, section1Ref, section2Ref, section3Ref, section4Ref];
  ...
  return (
    <div>
      ...
      <div className="px-4 content-center z-10 relative bg-main-bg" >
        <div className="content-center py-20" >
          <div className="m-auto">
            <p className={`text-sm font-GTPressura-Bold text-center ${isScrolledToSection.section1? 'text-dark-bg' : 'text-main-bg'} animate-duration pb-5`}>GREENPOINT</p>
          </div>
          <div className="xl:w-[600px] m-auto mb-4">
            <p className={`text-center font-GTPressura-Light text-5xl ${isScrolledToSection.section1? 'text-dark-bg' : 'text-main-bg'} animate-duration px-4`}>TAn Authenically 
            Brooklyn Condo</p>
          </div>
          <div className="flex items-center">
            <div className="w-auto mx-auto xl:w-1/3">
              <p className={`text-base font-GTPressura-Light text-center ${isScrolledToSection.section1? 'text-dark-bg' : 'text-main-bg'} animate-duration px-4`}>An ever-evolving, vibrant enclave, Greenpoint’s authenticity is emphatically Brooklyn. Both gritty and refined, Greenpoint is home to artists, restaurants, shops, and culture that keep New York exciting.</p>
            </div>
          </div>
      ...
      <div className="px-4 content-center z-10 relative bg-main-bg" >
        <div className={`w-full flex md:mx-32 ${isScrolledToSection.section0? 'text-dark-bg' : 'text-main-bg'} mb-12 animate-duration text-[24px] lg:px-6`}>
        ...
        <div className="w-full flex">
          <div className="w-full md:mx-32 lg:flex mb-6">
            <div className="w-full lg:px-6">
              <p className={`${isScrolledToSection.section0?'text-dark-bg' : 'text-main-bg'} animate-duration text-[34px] uppercase`}>
                union center flushing
              </p>
            </div>
            <div className="w-full lg:px-6 mb-6">
              <p className={`${isScrolledToSection.section0?'text-dark-bg' : 'text-main-bg'} animate-duration text-base text-justify`}>
                When you make your home in Flushing, Queens, you make your home in one of New York City’s most vibrant and diverse neighborhoods. Flushing is known for its storied culinary history and deep Asian cultural roots. You will find yourself at the crossroads of a unique past and a neighborhood’s exciting future. Your exploration will also lead you to discover hidden gems, from sprawling parks and botanical gardens to world-class museums and performance spaces.
              </p>
            </div>
            <div className="w-full lg:px-6 mb-6">
              <p className={`${isScrolledToSection.section0?'text-dark-bg' : 'text-main-bg'} animate-duration text-base text-justify`}>
              Flushing also offers a bustling nightlife and a weekend destination where friends and families come together with Tangram at its social epicenter. Celebrated as one of the major foodie neighborhoods in New York City, if not the country, your taste buds will delight at the Asian authentic cuisine that takes you on a memorable culinary journey.
              </p>
            </div>
          </div>
        </div>
        ...
        <div ref={section0Ref} id="section0" className="absolute top-48 lg:top-24"></div>
      </div>
      ...
      <div className="w-full bg-cover bg-center h-screen" style={{ backgroundImage: `url(${'./img/gallery/gallery19.jpg'})`}}>
